      ...
      <DialogContent className="sm:max-w-[560px]">
        <DialogHeader>
          <div className="flex items-center gap-2">
            ...
            <div>
              <DialogTitle>{t("dialog.discord.title")}</DialogTitle>
              <DialogDescription className="pt-2">
                {t("dialog.discord.description")}{" "}
        ...
        >
          <FieldGroup>
            <FieldLabel htmlFor="credentialId">{t("dialog.discord.credential")}</FieldLabel>
            <Select
              value={credentialId}
              onValueChange={(value) =>
            ...
            >
              <SelectTrigger className="w-full">
                <SelectValue placeholder={t("dialog.discord.selectCredential")} />
              </SelectTrigger>
              <SelectContent>
          ...
          <FieldGroup>
            <FieldLabel htmlFor="credentialField">{t("dialog.discord.secretField")}</FieldLabel>
            <Field>
              <Input
                id="credentialField"
          ...
          <FieldGroup>
            <div className="flex items-center justify-between gap-3">
              <FieldLabel htmlFor="content">{t("dialog.discord.message")}</FieldLabel>
          ...
          <FieldGroup className="rounded-xl border border-border/70 bg-muted/20 p-4">
            <div className="flex items-start justify-between gap-3">
              <div className="space-y-1">
                ...
                <FieldDescription>
                  {t("dialog.discord.writeMemoryDescription")}
                  {" "}
